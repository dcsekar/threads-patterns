 ...
 *
 * This application demonstrates 11 essential Java 21 concurrency patterns:
 ...
 * - Run specific demo: mvn spring-boot:run -Dspring-boot.run.arguments=--demo=countdownlatch
 * - Run tests: mvn test
 *
 * For comprehensive documentation, see README-THREAD-PATTERNS.md
 */
